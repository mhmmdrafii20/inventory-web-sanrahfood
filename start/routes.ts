...
router
    .group(() => {
        ...
        router.get('/produk/trash/search', [ProdukController, 'searchTrash']).as('produk.searchTrash');
        ...
        router.get('/role/trash/search', [HakAksesController, 'searchTrash']).as('hakAkses.searchTrash');
        ...
        router.patch('/pengguna/restore/:id', [PenggunaController, 'restore']).as('pengguna.restore');
        router.get('/pengguna/trash/search', [PenggunaController, 'searchTrash']).as('pengguna.searchTrash');
        ...
        router.get('/kategori-produk/edit/:id', [KategoriController, 'edit']).as('kategoriProduk.edit');
        router.put('/kategori-produk/update/:id', [KategoriController, 'update']).as('kategoriProduk.update');
        ...
        router.get('/kategori-produk/trash', [KategoriController, 'trash']).as('kategoriProduk.trash');
        router.patch('/kategori-produk/restore/:id', [KategoriController, 'restore']).as('kategoriProduk.restore');
        router.get('/kategori-produk/trash/search', [KategoriController, 'searchTrash']).as('kategoriProduk.searchTrash');
        ...
        router.get('/daftar-penerima/edit/:id', [DaftarPenerimaController, 'edit']).as('daftarPenerima.edit');
        router.put('/daftar-penerima/update/:id', [DaftarPenerimaController, 'update']).as('daftarPenerima.update')
        router.delete('/daftar-penerima/delete/:id', [DaftarPenerimaController, 'destroy']).as('daftarPenerima.destroy');
        ...
        router.get('/tipe-notifikasi/edit/:id', [TipeNotifikasiController, 'edit']).as('tipeNotifikasi.edit');
