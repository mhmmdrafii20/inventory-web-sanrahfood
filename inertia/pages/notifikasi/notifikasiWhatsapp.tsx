        ...
        <>
            ...
            <div className=" flex flex-wrap w-full mx-auto justify-center max-w-4xl gap-5">
                <div className="flex flex-col bg-white shadow-md rounded-md mt-5 p-6 gap-6 w-96">
                    ...
                    {(whatsappSession?.status === "NOT_CONNECTED" || whatsappSession?.status === undefined) && (
                        <>
                            <Paragraph size="md" color="dark_grey">Klik tombol di bawah untuk menghubungkan WhatsApp ke sistem.</Paragraph>
                            <Button
                    ...
                    {whatsappSession?.status === "QR_READY" && (
                        <>
                            ...
                            <Modal open={open} onClose={() => setIsOpen(false)} closeOnEsc={false} closeOnOverlayClick={false} center styles={{ modal: { width: "1024px" } }}>
                ...
                <div className="flex flex-col bg-white shadow-md rounded-md mt-5 p-6 gap-6 w-96">
                    <Heading level={2} color="dark_slate_grey" className="font-bold">Daftar Penerima</Heading>
                    <Paragraph size="md" color="dark_grey">Kelola daftar kontak yang akan menerima notifikasi WhatsApp.</Paragraph>
                    <Button variant={1} size="md" className="w-fit">
                        <Link route="daftarPenerima.index">Daftar Penerima</Link>
                    </Button>
                </div>
                <div className="flex flex-col bg-white shadow-md rounded-md mt-5 p-6 gap-6 w-96">
                    <Heading level={2} color="dark_slate_grey" className="font-bold">Atur Tipe Notifikasi</Heading>
                    <Paragraph size="md" color="dark_grey">Kelola dan konfigurasi tipe/jenis notifikasi yang tersedia.</Paragraph>
                    <Button variant={1} size="md" className="w-fit">
