...
export default function DaftarPenerima() {
  const { tipeNotifikasi, pengguna, errors, dataDaftarPenerima, dataSpecificTipeNotifikasi } =
    usePage<{
      ...
      dataDaftarPenerima: {
        id_penerima_notifikasi: number
        nama_penerima: string
        id_pengguna: string
        nomor_telepon: string
        pengguna: { namaPengguna: string; nomorTelepon: string }
      }
      dataSpecificTipeNotifikasi: number[]
    }>().props
    ...
    <>
      ...
      >
        <Input
          ...
          size="md"
          type="hidden"
          name="id_penerima_notifikasi"
          value={data.id_penerima_notifikasi}
          onChange={(e) => setData('id_penerima_notifikasi', parseInt(e.target.value))}
        />
        {isInternal && (
          <>
