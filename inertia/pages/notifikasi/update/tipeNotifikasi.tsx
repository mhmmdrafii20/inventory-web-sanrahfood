...
export default function TipeNotifikasi() {
    const { dataTipeNotifikasi, errors } = usePage<{ dataTipeNotifikasi: { id_tipe_notifikasi: number, kode_notifikasi: string; nama_notifikasi: string; template_variables?: string[] } }>().props;
