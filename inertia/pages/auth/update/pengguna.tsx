...
export default function Pengguna() {
    const { role, dataPengguna, auth, errors } = usePage<{ flash?: { success?: string; error?: string }, role: { idHakAkses: number, namaHakAkses: string }[], dataPengguna: { id: number, id_pengguna: string, id_hak_akses: number, nama_pengguna: string, nomor_telepon: string }, auth: { data: { user: { id: string, email: string } } } }>().props;
