...
import { FaPen, FaTrash, FaSearch, FaTrashRestore } from 'react-icons/fa'
...
export default function Pengguna() {
  ...
  const { role, pengguna, errors, searchRes } = usePage<{
  ...
  return (
    <>
      ...
      <div className="flex flex-col  w-full bg-white shadow-md rounded-md p-5 mt-3">
            ...
            <form className="flex flex-col gap-2" onSubmit={handleCreate}>
              ...
              <div className="flex flex-col gap-3">
                ...
                <Select
                  ...
                  size="md"
                  name="id_hak_akses"
                  onChange={(e) => setData('id_hak_akses', e.target.value)}
                >
            ...
            {displayPengguna?.length > 0 ? (
                ...
                <tr key={items.idPengguna}>
                  ...
                  <td className="border border-gray-300 py-3 px-5">
                    <div className="flex flex-row gap-2 justify-center">
                      <Link route="pengguna.edit" routeParams={{ id: items.idPengguna }}>
                        <ActionButton
                          as="div"
                          className="flex items-center"
                          type="update"
                      ...
                      <ActionButton
                        type="delete"
                        size="sm"
                        onClick={() => handleDelete(items.idPengguna)}
                      >
                        <FaTrash />
                      </ActionButton>
                    </div>
              ...
              <tr>
                <td colSpan={4} className="border border-gray-300 py-3 text-center">
                  <Paragraph size="lg">Tidak ada pengguna</Paragraph>
                </td>
              </tr>
            )}
          </tbody>
