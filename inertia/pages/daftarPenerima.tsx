        ...
        <>
            ...
            <div className="flex flex-row justify-between mt-5">
                        ...
                        {tipePenerima === "Internal" && (
                            <>
                                ...
                                <Select variant={1} size="md" name="id_pengguna" value={data.id_pengguna} onChange={(e) => setData('id_pengguna', e.target.value)}>
                                    ...
                                    {pengguna?.map((items => (
                                        <option value={items.idPengguna}>{items.namaPengguna}</option>
                                    )))}
                                </Select>
                ...
                <div className="flex flex-row gap-5 ">
                    <Input variant={1} size="md" type="text" placeholder="Cari Daftar Penerima" value={searchData} onChange={(e) => setSearchData(e.target.value)}></Input>
                        ...
                        <tr key={items.idPenerimaNotifikasi}>
                            ...
                            <td className="border border-gray-300 py-3 px-5">
                                <div className="flex flex-row gap-2 justify-center">
                                    <Link route='updateBahan.edit' routeParams={{ id: items.idPenerimaNotifikasi }}>
