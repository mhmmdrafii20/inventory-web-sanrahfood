              ...
              {displayRiwayatStokBahanBaku?.length > 0 ? (
                displayRiwayatStokBahanBaku?.map((items) => (
                  <tr key={items.idRiwayatStokBb}>
                    ...
                    <td className="border border-gray-300 py-3 px-5">
                      <Paragraph size="lg">
                        {items.selisihStok} {items.stokBahanBaku.bahan.satuan}
                      </Paragraph>
                    </td>
                    <td className="border border-gray-300 py-3 px-5">
                      <Paragraph size="lg">
                        {items.stokSebelum} {items.stokBahanBaku.bahan.satuan}
                      </Paragraph>
                    </td>
                    <td className="border border-gray-300 py-3 px-5">
                      <Paragraph size="lg">
                        {items.stokSesudah} {items.stokBahanBaku.bahan.satuan}
                      </Paragraph>
                    </td>
                    <td className="border border-gray-300 py-3 px-5">
                      <Paragraph
