...
export default function Update() {
    const { dataBahan, dataStokBahan, errors } = usePage<{ dataBahan: { id_bahan_baku: number; nama_bahan_baku: string; satuan: string; }, dataStokBahan: { stok_minimum: number } }>().props;
    ...
    return (
        <>
            ...
            <form className="flex flex-col gap-5 bg-white p-5 shadow-md rounded-md w-[600px] mx-auto" onSubmit={handleUpdate}>
                ...
                <Input variant={1} size="md" type="number" value={data.stok_minimum} onChange={(e) => setData("stok_minimum", Number(e.target.value))} />
